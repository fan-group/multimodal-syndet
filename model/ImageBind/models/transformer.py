...
class Attention(nn.Module):
    def __init__(
        ...
        self.qkv = lora.MergedLinear(dim, dim * 3, bias=qkv_bias, r=32, enable_lora=[True, False, True])
...
class Mlp(nn.Module):
    def __init__(
        ...
        self.fc1 = lora.Linear(in_features, hidden_features,r=32)
        self.act = act_layer()
        self.fc2 = lora.Linear(hidden_features, out_features,r=32)
